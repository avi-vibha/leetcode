...
public class A009_122_BuySellStocks2 {
    ...
    // The above version calculates the difference always, then checks diff > 0.  (makes it fater in Leetcode)
    // Your version  below alculates prices[i] - prices[i-1] only if the condition is true.
